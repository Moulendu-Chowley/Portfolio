...
const TestimonialCard: React.FC<TestimonialCardProps> = ({
  ...
  return (
    <div className={`relative flex flex-col h-auto w-full rounded-[20px] overflow-hidden outline outline-1 outline-offset-[-1px] outline-[#6971a2]/40 border border-transparent bg-clip-padding ${className}`} style={{ background: "var(--gradient-statcard)" }}>
