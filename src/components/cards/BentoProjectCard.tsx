...
export const BentoProjectCard: React.FC<BentoProjectCardProps> = ({
  ...
  // Handler to open the modal with the current project
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Hover Glow Effect */}
        <motion.div
          className="absolute inset-0 bg-gradient-to-t from-[#4F46E5]/10 via-transparent to-transparent z-5 pointer-events-none"
        ...
        <motion.div
          className="absolute inset-0 rounded-2xl border-2 border-[#4F46E5]/60 z-30 pointer-events-none"
          animate={{
