export const PageBreak = () => (
  <div className="relative w-full max-w-7xl mx-auto h-10 sm:h-14 md:h-20 lg:h-28 xl:h-32 2xl:h-40 flex items-start justify-center">
    ...
    <div
      ...
      style={{
        background:
          "radial-gradient(ellipse 89.28% 89.28% at 50% 0%, #1c0050 0%, rgba(11,1,29,0.02) 57%)",
      }}
    />
    ...
    <div className="absolute left-0 top-[2.8px] w-full h-0 outline-2 outline-offset-[-1px] outline-[#0b011d]/0" />
  </div>
);
