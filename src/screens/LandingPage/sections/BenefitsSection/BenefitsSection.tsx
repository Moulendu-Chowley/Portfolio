...
export const BenefitsSection = () => {
  ...
  return (
    <section
      id="benefits"
      className="flex flex-col items-center w-full relative px-6 py-16"
    >
      {/* Blue gradient background elements */}
      <div className="absolute top-1/3 left-1/6 w-80 h-80 bg-[#4F46E5]/6 rounded-full blur-3xl" />
      <div className="absolute bottom-1/3 right-1/6 w-96 h-96 bg-[#4F46E5]/4 rounded-full blur-3xl" />
      <PageBreak />
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 grid-rows-4 gap-4 w-full max-w-6xl mx-auto auto-rows-[160px] md:auto-rows-[180px]">
        ...
        >
          ...
          <motion.div
            ...
            animate={{
              ...
              scale: isHovered ? 1.06 : 0.8,
              x: isHovered ? 64 : 0,
            }}
            transition={{ duration: 0.4, ease: "easeInOut" }}
          >
            <Spotlight
              className="absolute left-1/2 top-1/2 -translate-x-1/4 -translate-y-1/2 w-[120%] h-[120%]"
              fill="#4F46E5"
              fillOpacity={0.18}
            />
            <Spotlight
              className="absolute left-1/2 top-1/4 -translate-x-1/2 -translate-y-1/4 w-[120%] h-[120%]"
              fill="#3B82F6"
              fillOpacity={0.5}
            />
          </motion.div>
          <div className="relative z-10 flex flex-col items-center w-full h-full pt-8 md:pt-6 pb-0 overflow-visible">
            <div className="text-center mb-3 md:mb-5">
              <span className="text-white/100 text-[24px] md:text-2xl font-semibold leading-relaxed">
                Responsive by{" "}
              </span>
              <span className="text-[#A5B4FC] text-[24px] md:text-2xl font-semibold leading-relaxed">
                Design
              </span>
            </div>
            {/* Animated Devices */}
            ...
            >
              <Image
                src="/tabletsc.svg"
                alt="Tablet"
                className="relative z-0 w-[140px] h-[180px] md:w-[200px] md:h-[240px] object-contain -mr-6 md:-mr-14"
                width={200}
                height={240}
              />
              <Image
                src="/mobilesc.svg"
                alt="Mobile"
                className="relative z-1 w-[60px] h-[110px] md:w-[90px] md:h-[150px] object-contain md:mx-4"
                width={90}
                height={150}
              />
              <Image
                src="/laptopsc.svg"
                alt="Laptop"
                className="relative z-0 w-[200px] h-[140px] md:w-[290px] md:h-[200px] object-contain -ml-6 md:-ml-14"
                width={290}
                height={200}
              />
            </motion.div>
        ...
        >
          ...
          <motion.div
            ...
            animate={{ opacity: isHoveredSecurity ? 0.15 : 0.1 }}
            transition={{ duration: 0.4, ease: "easeInOut" }}
            style={{
              background:
                "radial-gradient(circle at left bottom, rgba(255,140,0,1) 0%, transparent 60%)",
            }}
          />
          <motion.div
            className="flex flex-col items-center justify-center h-full w-full gap-4 py-8"
            animate={{ scale: isHoveredSecurity ? 1.04 : 1 }}
            transition={{ duration: 0.4, ease: "easeInOut" }}
          >
            <motion.img
              src="/security.svg"
              ...
              animate={{
                ...
                filter: isHoveredSecurity
                  ? "drop-shadow(0 0 16px rgba(255,140,0,0.10))"
                  : "none",
              }}
              transition={{ duration: 0.4, ease: "easeInOut" }}
            />
            <motion.div
              ...
              transition={{ duration: 0.4, ease: "easeInOut" }}
            >
              <span className="text-[#A5B4FC] font-semibold text-[20px] md:text-2xl">
                Security
              </span>
              <span className="text-white font-semibold text-[20px] md:text-2xl">
                -First
              </span>
              <br />
              <span className="text-white font-semibold text-[16px] md:text-2xl">
                Approach
              </span>
            </motion.div>
          </motion.div>
        ...
        >
          <div className="flex flex-col w-full pt-6 md:pt-12 md:pb-4">
            ...
            >
              ...
              <span className="text-[#A5B4FC]">Dev.</span>
            </motion.div>
            <motion.div
            ...
            >
              <span className="text-white">Fast </span>
              <span className="text-[#A5B4FC]">load.</span>
            </motion.div>
          </div>
          <motion.img
            src="/fast.png"
            ...
            animate={{
              ...
              filter: isHoveredFastDev
                ? "drop-shadow(0 0 16px rgba(145,108,231,0.20))"
                : "none",
            }}
            transition={{ duration: 0.4, ease: "easeInOut" }}
        ...
        <Card
          className="rounded-[18.88px] md:col-span-3 md:row-span-1 flex flex-col justify-between p-0 bg-[linear-gradient(60deg,#090831,#040022)] outline-[0.94px] outline-offset-[-0.94px] outline-[#6971a2]/40 overflow-hidden relative"
        ...
        >
          <div className="absolute md:left-[339.10px] md:top-[30.21px] top-4 text-center justify-start z-10">
            <span className="text-[#A5B4FC] text-lg md:text-2xl font-semibold font-['Inter','Helvetica'] leading-relaxed">
              ROI-Driven
            </span>
            <span className="text-white/60 text-lg md:text-2xl font-semibold font-['Inter','Helvetica'] leading-relaxed">
              {" "}
              Solutions.
            </span>
          </div>
        ...
        <Card className="rounded-[19.15px] row-span-2 md:col-span-1 md:row-span-2 h-auto flex flex-col justify-between p-0 relative overflow-hidden outline-1 outline-offset-[-0.96px] outline-[#6971a2]/40 bg-[linear-gradient(60deg,#090831,#040022)]">
          ...
          <div className="absolute md:w-[225px] w-full md:left-[38px] left-4 md:top-[39px] top-4 text-left z-10">
            <span className="text-white/80 text-2xl font-semibold font-['Inter','Helvetica'] leading-relaxed">
              Professional{" "}
            </span>
            <span className="text-[#A5B4FC] text-2xl font-semibold font-['Inter','Helvetica'] leading-relaxed">
              Integrations.
            </span>
          </div>
          ...
          <div className="absolute z-10 w-full md:px-4 left-0 md:top-[140px] top-34 h-[calc(100%-110px)] flex flex-col gap-6">
            <div className="flex justify-start pl-4">
              <CardButton
                icon="/webflow.svg"
                className="px-4 py-2 text-white text-[19px] font-semibold"
              >
                webflow
              </CardButton>
            </div>
        ...
        <Card className="rounded-[19.15px] md:col-span-2 md:row-span-1 flex flex-col md:flex-row justify-center items-center md:items-stretch p-0 relative overflow-hidden outline-1 outline-offset-[-0.96px] outline-[#6971a2]/40 bg-[linear-gradient(60deg,#090831,#040022)]">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center w-full h-full">
            <div className="flex flex-col justify-center items-center md:items-start gap-[4px] md:gap-[9px] px-3 md:px-[62px] py-0 z-10">
              <div className="w-full md:w-[237px] text-center md:text-left">
                <span className="text-[#A5B4FC] text-base md:text-2xl font-semibold font-['Inter','Helvetica'] leading-relaxed">
                  Time-Efficient
                </span>
                <span className="text-white/60 text-base md:text-2xl font-semibold font-['Inter','Helvetica'] leading-relaxed">
                  {" "}
                  Delivery.
                </span>
              </div>
              <div className="text-[#9f9eab] text-xs md:text-base font-semibold font-['Inter','Helvetica'] leading-[14px] md:leading-[17.6px] text-center md:text-left">
                Balancing speed and design precision.
              </div>
            </div>
            ...
            <div className="flex items-center justify-center mt-6 md:mt-0 md:ml-4 md:self-center md:mr-[40px] z-0">
              <Image
                src="/clockcard.svg"
                alt="Clock Card"
                className="w-[110px] h-[110px] md:w-[180px] md:h-[180px]"
                width={180}
                height={180}
              />
            </div>
        ...
        <Card className="rounded-[19.15px] md:col-span-1 md:row-span-1 flex flex-col items-center justify-end p-0 relative overflow-hidden">
          ...
          <Image
            src="/cms.png"
            alt="Custom CMS"
            className="relative z-10 w-[60%] md:max-w-[320px] md:mt-10 mb-3 md:mb-6"
            width={320}
            height={180}
          />
          {/* Title */}
          <div className="relative z-10 text-center mb-4 md:mb-8">
            <span className="block text-[18px] md:text-2xl font-semibold text-white/80 leading-tight">
              Powerful, Custom
            </span>
            <span className="block text-[18px] md:text-2xl font-semibold text-[#A5B4FC] leading-tight">
              CMS
            </span>
          </div>
        </Card>
        ...
        <Card className="rounded-[19.15px] md:col-span-1 md:row-span-1 flex flex-col items-center justify-end p-0 relative overflow-hidden md:col-start-2">
          ...
          <Image
            src="/SEO.svg"
            alt="SEO"
            className="absolute inset-0 w-auto h-full p-5 md:p-10 object-contain z-0 select-none pointer-events-none"
            width={200}
            height={200}
          />
          {/* Title */}
          <div className="relative z-10 text-center mb-4 md:mb-8">
            <span className="text-[18px] md:text-2xl font-bold text-[#A5B4FC]">
              SEO
            </span>
            <span className="text-[18px] md:text-2xl font-bold text-white/80 ml-2">
              that Works
            </span>
          </div>
        </Card>
        {/* Clear & Consistent Communication Card */}
        <Card className="relative col-span-2 row-span-1 w-auto bg-[linear-gradient(60deg,#090831,#040022)] rounded-[19.15px] overflow-hidden md:col-span-2 md:row-span-1 p-0">
          ...
          <div className="absolute md:left-[40px] left-4 md:top-[70px] top-4 text-left z-10">
            <div className="text-white/100 text-[16px] md:text-2xl font-semibold font-['Inter','Helvetica'] leading-relaxed inline-block mr-1">
              Clear &amp; Consistent
            </div>
            <div className="text-[#A5B4FC] text-[16px] md:text-2xl font-semibold font-['Inter','Helvetica'] leading-relaxed inline-block">
              Communication
            </div>
          </div>
          <div className="absolute md:left-[40px] left-4 md:top-[120px] top-10 text-left z-10">
            <div className="text-white/60 text-[16px] md:text-2xl font-semibold font-['Inter','Helvetica'] leading-relaxed inline-block mr-1">
              Proven
            </div>
            <div className="text-[#A5B4FC] text-[16px] md:text-2xl font-semibold font-['Inter','Helvetica'] leading-relaxed inline-block">
              Experience
          ...
          {/* Planets */}
          <Image
            src="/Planetorange.svg"
            alt="Planet Orange"
            className="absolute left-[-10px] md:left-[-10px] bottom-[-10px] md:bottom-[-10px] w-[100px] md:w-[120px] h-[100px] md:h-[120px] z-8"
            style={{ filter: "drop-shadow(0 0 32px rgba(255,172,77,0.5))" }}
            width={120}
            height={120}
          />
          <Image
            src="/Planetblue.svg"
            alt="Planet Blue"
            className="absolute right-[10px] md:right-[30px] top-[10px] md:bottom-[20px] w-[160px] md:w-[200px] h-[160px] md:h-[200] z-8"
