    ...
    >
      ...
      <div className="w-full max-w-2xl mx-auto flex flex-col gap-2 sm:gap-3 md:gap-4">
        {faqTabs[activeTab].questions.map((q) => (
          <div
            key={q}
            className="w-full px-2 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 rounded-2xl bg-[linear-gradient(60deg,#090831,#040022)] outline-1 outline-[#4F46E5]/20 border border-[#4F46E5]/10 flex items-center justify-between text-left transition-all duration-200 hover:scale-[1.01] hover:shadow-lg hover:border-[#4F46E5]/30"
          >
